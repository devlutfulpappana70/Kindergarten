...
class Kidsa_Breadcrumb {
	/**
	 * Array of bread Kidsa_Breadcrumb
	 *
	 * @var array
	 */
	...
	public function __construct( array $options = [] ) {
		...
		$this->defaults['home'] = esc_html__('Home','kidsa');
		$this->defaults['blog'] = esc_html__('Blog','kidsa');
	...
	public function theBreadcrumbs() {
		...
		foreach ( $breadcrumbs as $crumb ) {
			...
			if ( $crumb['url'] ) {
                ...
                $html .= sprintf( '<span>%s</span>', wp_kses($crumb['title'],kidsa()->kses_allowed_html('all')) );
			}
		...
		echo wp_kses($html,kidsa()->kses_allowed_html('all'));
	}
	...
	public function getBreadcrumbs() {
		...
		$breadcrumbs = apply_filters( 'kidsa_get_breadcrumbs', $breadcrumbs );
 ...
 * Template Functions.
 */
if ( ! function_exists( 'kidsa_breadcrumb' ) ) {
	/**
	 ...
	 * @package kidsa
	 */
	function kidsa_breadcrumb( $options = [] ) {
		$Crumbs = new Kidsa_Breadcrumb( $options );
		$Crumbs->theBreadcrumbs();
	}
}

if ( ! function_exists( 'kidsa_get_breadcrumbs' ) ) {
	/**
	 ...
	 * @return array
	 */
	function kidsa_get_breadcrumbs( $options = [] ) {
		$Crumbs = new Kidsa_Breadcrumb( $options );
 ...
 * Utility functions
 */
if ( ! function_exists( 'kidsa_breadcrumb_array_insert' ) ) {
	/**
	 ...
	 * @return array
	 */
	function kidsa_breadcrumb_array_insert( array $array, $element, int $position ) {
