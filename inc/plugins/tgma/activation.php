 ...
 * @subpackage Example
 * @version    2.6.1 for parent theme kidsa for publication on ThemeForest
...
add_action( 'tgmpa_register', 'kidsa_register_required_plugins' );
 ...
 */
function kidsa_register_required_plugins() {
	...
	$plugins = array(
        ...
        array(
            'name'         => 'Kidsa Core',
            'slug'         => 'kidsa-core',
            'source'       => 'https://gramentheme.com/demo-plugin/kidsa/kidsa-core.zip',
            'required'     => true,
            'version'      => '1.1.0',
