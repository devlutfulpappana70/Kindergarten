...
if (!class_exists('Kidsa_Helper_Functions')) {

    class Kidsa_Helper_Functions
    {
        /**
         * $instance
         * @since 1.0.0
        ...
        function post_thumbnail($size = 'kidsa_classic')
        {
        ...
        public function link_pages()
        {
            ...
            $defaults = array(
                'before' => '<div class="wp-link-pages"><span>' . esc_html__('Pages:', 'kidsa') . '</span>',
                'after' => '</div>',
                'link_before' => '',
                'link_after' => '',
        ...
        {
            global $wp_query;
            $allowed_html = kidsa()->kses_allowed_html('all');
            $big = 12345678;
            if (null == $nav_query) {
        ...
        public function posted_by()
        {
            ...
            /* translators: %s: post author. */
                esc_html_x(' %s', 'post author', 'kidsa'),
        ...
        public function author_avatar($post_id)
        {
            ...
            printf('<div class="post-author"><div class="author-image"><img src="%1$s" class="image-fit rounded-circle" alt="%3$s"></div><a href="%2$s"> ' . esc_html__("By", "kidsa") . ' %3$s </a></div>', $author_image, $author_link, $author_name);
        }
        ...
        public function author_biography($post_id)
        {
            ...
            printf('<div class="post-author"><div class="author-image"><img src="%1$s" class="image-fit" alt="%3$s"></div><div class="author-content"><cite class="post-by">' . esc_html__('Written By', 'kidsa') . '</cite><h3 class="title">%2$s</h3><p>%4$s</p></div></div>', $author_image, $author_name, $author_name, $author_desc);
        }
        ...
        public function posted_tag()
        {
            ...
            $tags_list = get_the_tag_list('', esc_html_x(' ', 'list item separator', 'kidsa'));
            if ($tags_list) {
                    ...
                    <div class="prev-post">
                        <a href="<?php echo esc_url(get_permalink($prev_post->ID)); ?>">
                            <div class="title-with-link">
                                ...
                                <span class="ms-2"><?php esc_html_e('Prev Post', 'kidsa') ?></span>
                ...
                <?php if (!empty($next_post)): ?>
                    <div class="next-post">
                        <a href="<?php echo esc_url(get_permalink($next_post->ID)); ?>">
                            <div class="title-with-link">
                                <span class="me-2"><?php esc_html_e('Next Post', 'kidsa') ?></span>
        ...
        public function post_navigation_with_img()
        {
            ...
            if (!empty(get_previous_post_link())) {
                ...
                $output .= '<div class="content"><span class="prev-post">' . esc_html__('Previous', 'kidsa') . '</span>';
            ...
            if (!empty(get_next_post_link())) {
                ...
                $output .= '<div class="content"><span class="next-post">' . esc_html__('Next', 'kidsa') . '</span>';
         ...
         * @since 1.0.0
         */
        public function is_kidsa_active()
        {
            $theme_name_array = array('kidsa', 'Kidsa Child');
        ...
        /**
         * is kidsa core active
         * @since 1.0.0
         * */
        public function is_kidsa_core_active()
        {
            return defined('KIDSA_CORE_SELF_PATH');
        }
        ...
        public function comment_count()
        {
            ...
            $comment_text = ($comments_count > 1) ? esc_html__('Comments', 'kidsa') . ' (' . $comments_count . ')' : esc_html__('Comments', 'kidsa') . ' (' . $comments_count . ')';
    ...
    if (class_exists('Kidsa_Helper_Functions')) {
        Kidsa_Helper_Functions::getInstance();
    } 
