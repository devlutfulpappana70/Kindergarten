...
$footer_3_shape_1 = cs_get_option('footer_3_shape_1');
$footer_3_shape_2 = cs_get_option('footer_3_shape_2');
$footer_3_shape_3 = cs_get_option('footer_3_shape_3');
$footer_3_text = cs_get_option('footer_3_text');
$footer_3_contact_btn = cs_get_option('footer_3_contact_btn');
$footer_3_contact_btn_url = cs_get_option('footer_3_contact_btn_url');
...
$footer_3_form = cs_get_option('footer_3_form');
...
<footer class="footer-section section-bg fix">
            <div class="frame-shape style-2">
                <img src="<?php echo esc_url($footer_3_shape_1['url']); ?>" alt="shape-img">
            </div>
            <div class="frame-shape-3 float-bob-y">
                <img src="<?php echo esc_url($footer_3_shape_2['url']); ?>" alt="shape-img">
            </div>
                ...
                <div class="row">
                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".3s">
                        <div class="single-footer-widget">
                            ...
                            <div class="footer-content style-two">
                                <p>
                                    <?php echo esc_html($footer_3_text); ?>
                                </p>
                                ...
                                <a href="<?php echo esc_url($footer_3_contact_btn_url); ?>" class="theme-btn"><?php echo esc_html($footer_3_contact_btn); ?><i class="fa-solid fa-arrow-right-long"></i></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".7s">
                        <div class="single-footer-widget style-margin">
                            <div class="widget-head">
                                <h3><?php echo esc_html($footer_3_newsletter_title); ?></h3>
                            </div>
                           <div class="footer-content">
                                <p><?php echo esc_html($footer_3_newsletter_text); ?></p>
                                <div class="footer-input">
                                    <?php echo do_shortcode($footer_3_form); ?>
                                </div>
                           </div>
                        </div>
                    </div>
        ...
        <div class="footer-bottom">
            <div class="f-bottom-shape">
                <img src="<?php echo esc_url($footer_3_shape_3['url']); ?>" alt="shape-img">
            </div>
            <div class="container">
