...
$page_layout_meta = Kidsa_Group_Fields_Value::page_layout('kidsa');
$page_container_meta = Kidsa_Group_Fields_Value::page_container('kidsa','container_options');
...
if ('blank' == $page_layout_meta['layout']):
	...
	?>
    <div id="primary" class="content-area kidsa-page-content-area padding-120 page-content-wrap-<?php the_ID(); ?> <?php echo esc_attr($full_width_class);?>">
